...
**Caveat.** n = 4 → r=0.98 is ~significant (p≈0.02), r=0.89 is marginal (p≈0.11). Report as
"strongly suggestive + mechanistically sensible," not "established law." (Prime Pantry, though
excluded from results, would be a 5th point for *this* correlation if needed.)
...
**Overall Hit@1 (Δ over best pure model):** Luxury 0.622 (**+0.022**), All Beauty 0.606 (**+0.031**),
Fashion 0.308 (**+0.015**), Toys 0.266 (**+0.019**) — **positive on all 4**, ≈ oracle. Full per-metric
