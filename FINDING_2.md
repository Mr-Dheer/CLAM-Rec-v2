...
- **n = 4.** With the current 4 datasets **both** correlations are ~significant (interactions/item
  r = 0.979, t≈6.8, p ≈ 0.02; history length r = 0.990, t≈9.9, p ≈ 0.01; df=2) — but n=4 is small, so
  report as **"strongly suggestive and mechanistically sensible,"** not a proven law. (The earlier
  r=0.89 was with All Beauty, the outlier — see §6.)
